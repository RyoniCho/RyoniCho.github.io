            ...
            <div className="max-w-7xl mx-auto flex flex-col items-center text-center">
                <div className="mt-12 pt-8 border-t border-slate-200 dark:border-accent-gray/50 w-full flex flex-col md:flex-row justify-between items-center gap-6">
                    ...
                    <div className="flex gap-6">
                        {/* GitHub */}
                        <Link href="https://github.com/RyoniCho" target="_blank" className="text-slate-400 hover:text-primary transition-colors">
                        ...
                        {/* Instagram */}
                        <Link href="https://www.instagram.com/choeulyeon/" target="_blank" className="text-slate-400 hover:text-primary transition-colors">
                        ...
                        {/* Email */}
                        <Link href="mailto:carpinus0@gmail.com" className="text-slate-400 hover:text-primary transition-colors">
                            <span className="sr-only">Email</span>
                            <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24"><path d="M2.003 5.884L10 9.882l7.997-3.998A2 2 0 0016 4H4a2 2 0 00-1.997 1.884z" /><path d="M18 8.118l-8 4-8-4V14a2 2 0 002 2h12a2 2 0 002-2V8.118z" /></svg>
                        </Link>
                    </div>
                </div>
            </div>
